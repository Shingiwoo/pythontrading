# newrealtrading.py — FULL PATCH
# =============================================================
# Update: 2025-08-11
# Perubahan utama:
# 1) Integrasi ML live (RandomForest) via plugin: ml_signal_plugin.MLSignal
# 2) Skoring sinyal selaras backtester: base (+1) + ML (+1) vs SCORE_THRESHOLD
# 3) Safe Trailing Trigger: trailing baru aktif > biaya (taker*2 + slippage*2) + step + 0.05%
# 4) Loader config aman (coin_config.json + ENV) dengan casting yang robust
# 5) Hot-reload: _watch_config menambahkan kunci ML & scoring
# 6) Struktur tetap sederhana dan kompatibel untuk dihook ke eksekusi order
# =============================================================
